  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        {/* Card for SLN Public School */}
        <Card
          title="SLN Public School - ICSE"
          icon={<AceternityIcon order="Secondary School" />}
          des="Completed Nursery to Class 10 with Science, Math, and Computer as main subjects. Achieved 60% in Class 10."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        {/* Card for D.A.V Senior Secondary School */}
        <Card
          title="D.A.V Senior Secondary School- CBSE"
          icon={<AceternityIcon order="Sr. Se. School" />}
          des="Completed 11th and 12th with Physics, Chemistry, Math, and Computer as subjects. Achieved 56% in 12th."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        {/* Card for Parul University */}
        <Card
          title="Parul Institute of Engineering and Technology"
          icon={<AceternityIcon order="bachelor's degree" />}
          des="Completed B.Tech in Computer Science Engineering. Graduated with a CGPA of 7.14."
        >
          <CanvasRevealEffect
            animationSpeed={3}
